...
export default function MyPage() {
  ...
  if (authChecking) {
    return (
      <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center space-y-3 text-slate-500">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <section className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 relative z-10">
            ...
            <div className="flex items-start space-x-4">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-blue-700 flex items-center justify-center text-white text-xl sm:text-2xl font-black shadow-sm flex-shrink-0">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-slate-500 flex items-center space-x-2 flex-wrap">
                  ...
                  {industry && (
                    <>
                      <span>•</span>
                      <span className="text-indigo-600 font-semibold">{industry}</span>
                    </>
                  )}
                  {formattedRevenue && (
                    <>
                      <span>•</span>
                      <span className="text-emerald-700 font-semibold">연매출 {formattedRevenue}</span>
                    </>
                  )}
                </p>
              </div>
            ...
            <div className="grid grid-cols-3 gap-3 w-full lg:w-auto">
              <div className="bg-slate-50 border border-slate-200 p-3.5 rounded-2xl text-center min-w-[100px] sm:min-w-[125px] shadow-2xs">
                <span className="text-[10px] text-slate-500 font-medium block">프로필 완성도</span>
                <div className="text-lg sm:text-xl font-extrabold text-blue-600 mt-0.5">
                  {completionRate}%
                </div>
                <div className="w-full bg-slate-200 h-1.5 rounded-full mt-1.5 overflow-hidden">
                  <div className="bg-blue-600 h-full rounded-full transition-all duration-700" style={{ width: `${completionRate}%` }} />
                </div>
              </div>

              <div
                onClick={() => setActiveTab("plans")}
                className="bg-slate-50 border border-slate-200 hover:border-blue-400 p-3.5 rounded-2xl text-center min-w-[100px] sm:min-w-[125px] cursor-pointer transition-all shadow-2xs"
              >
                <span className="text-[10px] text-slate-500 font-medium block">작성 계획서</span>
                <div className="text-lg sm:text-xl font-extrabold text-indigo-600 mt-0.5">
                  {plans.length}건
                </div>
                <span className="text-[9px] text-indigo-600 font-semibold block mt-1">이력 확인 ➔</span>
              </div>
              ...
              <div
                ...
                className="bg-slate-50 border border-slate-200 hover:border-blue-400 p-3.5 rounded-2xl text-center min-w-[100px] sm:min-w-[125px] cursor-pointer transition-all shadow-2xs"
              >
                <span className="text-[10px] text-slate-500 font-medium block">관심 지원사업</span>
                <div className="text-lg sm:text-xl font-extrabold text-blue-600 mt-0.5">
                  {bookmarks.length}건
                </div>
                <span className="text-[9px] text-blue-600 font-semibold block mt-1">스크랩 목록 ➔</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="flex items-center space-x-2 border-b border-slate-200 pb-2">
          ...
          <button
            ...
            className="ml-auto p-2 text-slate-500 hover:text-slate-800 hover:bg-slate-100 rounded-xl transition-colors cursor-pointer"
            title="새로고침"
          >
        ...
        {saveSuccessMsg && (
          <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs flex items-center space-x-2 animate-in fade-in">
        ...
        {activeTab === "company" && (
          <div className="space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-5 sm:p-6 flex items-center justify-between flex-wrap gap-4 shadow-sm">
              <div className="flex items-center space-x-3">
                <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${
                  isEditingCompany ? "bg-amber-50 text-amber-700 border border-amber-200" : "bg-blue-50 text-blue-700 border border-blue-200"
                }`}>
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold border ${
                      isEditingCompany ? "bg-amber-50 text-amber-700 border-amber-200" : "bg-emerald-50 text-emerald-700 border-emerald-200"
                    }`}>
                ...
                {isEditingCompany ? (
                  <>
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold transition-colors flex items-center space-x-1.5 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      disabled={savingCompany}
                      className="px-5 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-bold transition-all shadow-sm shadow-blue-600/25 flex items-center space-x-1.5 cursor-pointer disabled:opacity-50"
                    >
                      {savingCompany ? (
                        <>
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition-all shadow-sm shadow-blue-600/25 flex items-center space-x-1.5 cursor-pointer"
                  >
            ...
            {!isEditingCompany && (
              <div className="space-y-6">
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-7 space-y-4 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
                    <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-1">
                      ...
                      <span className="font-bold text-sm text-slate-900">{name || "미등록"}</span>
                    </div>

                    <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-1">
                      <span className="text-slate-500 text-[11px] block">사업자등록번호</span>
                      <span className="font-semibold text-slate-800">{bizRegNo || "미등록 (예비창업)"}</span>
                    </div>

                    <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-1">
                      <span className="text-slate-500 text-[11px] block">주력 산업 분야 / 업종</span>
                      <span className="font-semibold text-blue-700">{industry || "미등록"}</span>
                    </div>
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-7 space-y-4 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                    <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-1">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="font-bold text-sm text-slate-900">{foundedDate ? `${foundedDate}` : "미등록"}</span>
                    ...
                    <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-1">
                      ...
                      <span className="font-bold text-sm text-slate-800">{employeeCount}명 (대표자 포함)</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-7 space-y-4 shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                    <span className="text-xs font-bold text-amber-800 uppercase tracking-wider flex items-center space-x-1.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                    <div className={`p-4 rounded-2xl border flex items-center space-x-3 ${
                      hasPatents ? "bg-amber-50/60 border-amber-200 text-amber-900" : "bg-slate-50 border-slate-200 text-slate-400"
                    }`}>
                    ...
                    <div className={`p-4 rounded-2xl border flex items-center space-x-3 ${
                      hasCertifications ? "bg-amber-50/60 border-amber-200 text-amber-900" : "bg-slate-50 border-slate-200 text-slate-400"
                    }`}>
                    ...
                    <div className={`p-4 rounded-2xl border flex items-center space-x-3 ${
                      isExporting ? "bg-amber-50/60 border-amber-200 text-amber-900" : "bg-slate-50 border-slate-200 text-slate-400"
                    }`}>
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-7 space-y-3 shadow-sm">
                  <span className="text-xs font-bold text-indigo-700 uppercase tracking-wider flex items-center space-x-1.5 border-b border-slate-100 pb-3">
            ...
            {isEditingCompany && (
              <form onSubmit={handleSaveCompany} className="space-y-6 animate-in fade-in duration-200">
                ...
                <div className="bg-white border border-blue-200 rounded-3xl p-6 sm:p-7 space-y-5 shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                    <div className="flex items-center space-x-2.5">
                      ...
                      <div>
                        <h3 className="text-sm sm:text-base font-bold text-slate-900">1. 기업 기본 식별 정보 수정</h3>
                        <p className="text-[11px] text-slate-500">기업체 공식 명칭 및 사업자등록 정보를 입력합니다.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-slate-300 focus:border-blue-600 focus:ring-1 focus:ring-blue-100 rounded-xl py-2.5 pl-10 pr-3 text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none transition-colors shadow-2xs"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-slate-300 focus:border-blue-600 focus:ring-1 focus:ring-blue-100 rounded-xl py-2.5 px-3 text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none transition-colors shadow-2xs"
                      />
                    </div>

                    {/* Region */}
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-700">사업장 소재지 지역 *</label>
                      <div className="relative">
                        <MapPin className="w-4 h-4 text-slate-400 absolute left-3.5 top-3" />
                        <select
                          value={region}
                          onChange={(e) => setRegion(e.target.value)}
                          className="w-full bg-white border border-slate-300 focus:border-blue-600 focus:ring-1 focus:ring-blue-100 rounded-xl py-2.5 pl-10 pr-3 text-xs text-slate-900 focus:outline-none transition-colors shadow-2xs"
                        >
                  ...
                  <div className="space-y-2 pt-1">
                    <label className="text-xs font-bold text-slate-700 flex items-center justify-between">
                      ...
                      <span className="text-[10px] text-blue-600">지원사업 매칭 핵심 기준</span>
                    </label>
                    <div className="relative">
                    ...
                    <div className="flex items-center flex-wrap gap-1.5 pt-1">
                      <span className="text-[10px] text-slate-400 mr-1">추천 태그:</span>
                ...
                <div className="bg-white border border-indigo-200 rounded-3xl p-6 sm:p-7 space-y-5 shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                    <div className="flex items-center space-x-2.5">
                      ...
                      <div>
                        <h3 className="text-sm sm:text-base font-bold text-slate-900">2. 업력 · 기업 규모 및 재무 역량 수정</h3>
                        <p className="text-[11px] text-slate-500">지원 자격 심사(초기창업, 도약, R&D 규모 요건)에 자동 판정됩니다.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-700 flex items-center justify-between">
                        <span>설립연월일 (창업일)</span>
                        <span className="text-[10px] text-emerald-700 font-semibold">{stageTrack.trackName}</span>
                      </label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-slate-300 focus:border-indigo-600 focus:ring-1 focus:ring-indigo-100 rounded-xl py-2.5 pl-10 pr-3 text-xs text-slate-900 focus:outline-none transition-colors shadow-2xs"
                        />
                      </div>
                      <p className="text-[10px] text-slate-400 pt-0.5">{stageTrack.description}</p>
                    </div>

                    {/* Employees */}
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-700">상시 근로자 수 (대표자 포함)</label>
                      <div className="relative">
                      ...
                      <p className="text-[10px] text-slate-400 pt-0.5">고용 인원 기준 지원 요건에 활용</p>
                    </div>
                    ...
                    <div className="space-y-1.5 sm:col-span-2 lg:col-span-1">
                      <label className="text-xs font-bold text-slate-700 flex items-center justify-between">
                        ...
                        {formattedRevenue && <span className="text-[10px] text-emerald-700 font-bold">{formattedRevenue}</span>}
                      </label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-slate-300 focus:border-indigo-600 focus:ring-1 focus:ring-indigo-100 rounded-xl py-2.5 pl-10 pr-3 text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none transition-colors shadow-2xs"
                        />
                      </div>
                      <p className="text-[10px] text-slate-400 pt-0.5">매출 규모 기준 R&D 및 수출 바우처 매칭</p>
                    </div>
                  </div>
                </div>

                {/* Card 3: Priority Extra Points & Certifications */}
                <div className="bg-white border border-amber-200 rounded-3xl p-6 sm:p-7 space-y-5 shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                    <div className="flex items-center space-x-2.5">
                      ...
                      <div>
                        <h3 className="text-sm sm:text-base font-bold text-slate-900">3. 정부 공통 우대 가점 및 특화 자격</h3>
                        <p className="text-[11px] text-slate-500">공고 심사 시 서류 통과율을 높여주는 핵심 가점 항목입니다.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <label className={`p-4 rounded-2xl border transition-all cursor-pointer flex items-start space-x-3 ${
                      hasPatents ? "bg-amber-50/60 border-amber-200 text-amber-900" : "bg-slate-50 border-slate-200 text-slate-600 hover:border-slate-300"
                    }`}>
                      <input
                        type="checkbox"
                        checked={hasPatents}
                        onChange={(e) => setHasPatents(e.target.checked)}
                        className="w-4 h-4 rounded border-slate-300 text-blue-600 focus:ring-0 mt-0.5 cursor-pointer"
                      />
                      <div className="space-y-1">
                        <span className="font-bold text-xs text-slate-900 block">특허 / 지식재산권(IP)</span>
                        <p className="text-[11px] text-slate-500">출원 또는 등록 특허 보유 (기술성 가점)</p>
                      </div>
                    </label>

                    <label className={`p-4 rounded-2xl border transition-all cursor-pointer flex items-start space-x-3 ${
                      hasCertifications ? "bg-amber-50/60 border-amber-200 text-amber-900" : "bg-slate-50 border-slate-200 text-slate-600 hover:border-slate-300"
                    }`}>
                      <input
                        type="checkbox"
                      ...
                      />
                      <div className="space-y-1">
                        <span className="font-bold text-xs text-slate-900 block">벤처기업 / 이노비즈 인증</span>
                        <p className="text-[11px] text-slate-500">정부 공인 벤처기업/연구소 인증 보유</p>
                      </div>
                    </label>

                    <label className={`p-4 rounded-2xl border transition-all cursor-pointer flex items-start space-x-3 ${
                      isExporting ? "bg-amber-50/60 border-amber-200 text-amber-900" : "bg-slate-50 border-slate-200 text-slate-600 hover:border-slate-300"
                    }`}>
                      <input
                        type="checkbox"
                        checked={isExporting}
                      ...
                      />
                      <div className="space-y-1">
                        <span className="font-bold text-xs text-slate-900 block">수출 실적 보유</span>
                        <p className="text-[11px] text-slate-500">글로벌 진출 및 직접/간접 수출 실적</p>
                      </div>
                    </label>
                  </div>
                </div>
                ...
                <div className="bg-white border border-indigo-200 rounded-3xl p-6 sm:p-7 space-y-5 shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                    <div className="flex items-center space-x-2.5">
                      ...
                      <div>
                        <h3 className="text-sm sm:text-base font-bold text-slate-900">4. 핵심 창업 아이템 및 비즈니스 모델(BM)</h3>
                        <p className="text-[11px] text-slate-500">PSST 사업계획서의 문제인식(P)과 해결방안(S) 섹션에 자동 인용됩니다.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <textarea
                      ...
                      className="w-full bg-white border border-slate-300 focus:border-indigo-600 focus:ring-1 focus:ring-indigo-100 rounded-2xl p-4 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none transition-colors leading-relaxed font-sans shadow-2xs"
                    />
                    <div className="flex items-center justify-between text-[11px] text-slate-400 px-1">
                      <span>최소 10자 이상 입력 시 AI 정밀 사업계획서 작성이 활성화됩니다.</span>
                      <span className={`${coreItemSummary.length >= 10 ? "text-indigo-600 font-bold" : "text-slate-400"}`}>
                ...
                <div className="sticky bottom-4 z-30 bg-white/95 backdrop-blur-md border border-slate-200 rounded-2xl p-4 flex items-center justify-between shadow-xl">
                  <button
                    type="button"
                    onClick={handleCancelEdit}
                    disabled={savingCompany}
                  ...
                  <button
                    type="submit"
                    disabled={savingCompany}
                    className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 hover:from-blue-500 hover:to-indigo-500 text-white text-xs sm:text-sm font-bold transition-all shadow-md shadow-blue-600/25 flex items-center space-x-2 cursor-pointer disabled:opacity-50"
                  >
                    {savingCompany ? (
                      <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {plans.map((p, idx) => (
                  <div
                    ...
                    className="p-5 rounded-2xl bg-white border border-slate-200 hover:border-blue-400 transition-all flex flex-col justify-between space-y-4 group shadow-2xs"
                  >
                    <div className="space-y-2">
                      ...
                      {p.score && (
                        <div className="pt-1">
                          <div className="flex items-center justify-between text-xs text-slate-500">
                            ...
                            <span className="font-bold text-indigo-700">{p.score} / 100점</span>
                          </div>
                          <div className="w-full bg-slate-100 h-1.5 rounded-full mt-1 overflow-hidden border border-slate-200">
                            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 h-full rounded-full" style={{ width: `${p.score}%` }} />
                          </div>
                        </div>
                      )}

                      <span className="text-[11px] text-slate-400 flex items-center space-x-1 pt-1">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                      ...
                      <button
                        ...
                        className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs transition-all shadow-xs flex items-center space-x-1.5 cursor-pointer"
                      >
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 space-y-4 shadow-sm">
            ...
            {bookmarks.length === 0 ? (
              <div className="py-20 text-center text-slate-400 text-xs space-y-3">
                ...
                <p className="text-sm font-semibold text-slate-700">찜한 관심 지원사업이 없습니다.</p>
              ...
              <div className="space-y-3">
                {bookmarks.map((b, idx) => (
                  <div
                    ...
                    className="p-5 rounded-2xl bg-white border border-slate-200 hover:border-blue-400 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4 group shadow-2xs"
                  >
                    <div className="space-y-1.5 flex-1 min-w-0">
                      <div className="flex items-center flex-wrap gap-2 text-[10px] text-slate-500">
                        ...
                        <span>{b.region}</span>
                        {b.endDate && (
                          <span className="flex items-center space-x-1 text-amber-700 font-medium ml-1">
