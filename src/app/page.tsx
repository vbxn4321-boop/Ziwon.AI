                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="flex items-center space-x-2 flex-wrap gap-y-2">
                    ...
                    <div className="bg-slate-950 p-1 rounded-xl border border-slate-800 flex space-x-1 text-xs">
                      <button
                        ...
                        className={`px-3.5 py-1.5 rounded-lg font-semibold transition-all ${bizFilterMode === "category"
                      ...
                      <button
                        ...
                        className={`px-3.5 py-1.5 rounded-lg font-semibold transition-all ${bizFilterMode === "ministry"
                          ? "bg-blue-900/90 text-blue-100 border border-blue-500/50 shadow-md"
                          : "text-slate-400 hover:text-slate-200"
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3.5 py-1.5 rounded-lg font-semibold transition-all ${bizFilterMode === "region"
                          ? "bg-blue-900/90 text-blue-100 border border-blue-500/50 shadow-md"
                          : "text-slate-400 hover:text-slate-200"
                          }`}
                      >
                  ...
                  <div className="flex items-center space-x-3 text-xs">
                    <button
                      ...
                      className={`px-3.5 py-1.5 rounded-xl border transition-all flex items-center space-x-2 ${onlyClosed
                    ...
                    <span
                      className={`px-2.5 py-1 rounded-xl border text-xs font-semibold ${onlyClosed
                  ...
                  {bizFilterMode === "category" &&
                    dbCategories.map((item) => (
                      <button
                        ...
                        className={`px-3.5 py-1.5 rounded-full text-xs font-medium transition-all flex items-center space-x-1.5 ${selectedCategory === item.name
                      ...
                      >
                        <span>{item.name}</span>
                        <span
                          className={`px-1.5 py-0.2 rounded-full text-[10px] ${selectedCategory === item.name
                  ...
                  {bizFilterMode === "ministry" &&
                    dbOrganizers.map((item) => (
                      <button
                        ...
                        className={`px-3.5 py-1.5 rounded-full text-xs font-medium transition-all flex items-center space-x-1.5 ${selectedOrganizer === item.name
                          ? "bg-blue-900/90 text-blue-200 border border-blue-500/60 shadow-md shadow-blue-500/20 font-bold"
                          : "bg-slate-900 text-slate-400 hover:text-slate-200 border border-slate-800"
                          }`}
                      >
                        ...
                        <span
                          className={`px-1.5 py-0.2 rounded-full text-[10px] ${selectedOrganizer === item.name
                            ? "bg-blue-500/30 text-blue-100 font-extrabold"
                            : "bg-slate-800 text-slate-400"
                            }`}
                        >
                  ...
                  {bizFilterMode === "region" &&
                    dbRegions.map((item) => (
                      <button
                        ...
                        className={`px-3.5 py-1.5 rounded-full text-xs font-medium transition-all flex items-center space-x-1.5 ${selectedRegion === item.name
                          ? "bg-blue-900/90 text-blue-200 border border-blue-500/60 shadow-md shadow-blue-500/20 font-bold"
                          : "bg-slate-900 text-slate-400 hover:text-slate-200 border border-slate-800"
                          }`}
                      >
                        <span>{item.name}</span>
                        <span
                          className={`px-1.5 py-0.2 rounded-full text-[10px] ${selectedRegion === item.name
                            ? "bg-blue-500/30 text-blue-100 font-extrabold"
                            : "bg-slate-800 text-slate-400"
                            }`}
                        >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-1.5">
                      {NAV_STAGES.map((stg) => (
                        <button
                          ...
                          className={`px-3 py-2 rounded-xl text-xs transition-all text-center ${navStage === stg
                    ...
                    <div className="space-y-1.5">
                      {NAV_AGES.map((ag) => (
                        <button
                          ...
                          className={`w-full px-3 py-2 rounded-xl text-xs transition-all text-left ${navAge === ag
                    ...
                    <div className="grid grid-cols-2 gap-1.5 max-h-48 overflow-y-auto pr-1">
                      {dbCategories.map((item) => (
                        <button
                          ...
                          className={`px-2.5 py-2 rounded-xl text-xs transition-all text-center flex items-center justify-between ${navCategory === item.name
                ...
                <div className="lg:col-span-8 space-y-4">
                  <div className="glass-panel p-4 rounded-2xl flex items-center justify-between text-xs">
                    ...
                    <button
                      onClick={() => setOnlyClosed(!onlyClosed)}
                      className={`px-3 py-1 rounded-xl border transition-all flex items-center space-x-2 ${onlyClosed
